...
class LitModel_Gosai(L.LightningModule):
    def __init__(
        ...
        lr: float = 3e-4,
        cell_types: list[str] = ["K562", "HepG2", "SKNSH"],
        lr_sheduler_to_use = "one_cycle", # or reducelronplateau or cosineannealing
        # Early stopping
    ...
    def configure_optimizers(self):
        ...
        if self.lr_sheduler_to_use == "one_cycle":
        ...
        elif self.lr_sheduler_to_use == "cosineannealing":
            ...
            lr_scheduler = torch.optim.lr_scheduler.CosineAnnealingWarmRestarts(
                optimizer=optimizer, T_0=4096, T_mult=1, eta_min=0.0, last_epoch=-1
            )
            lr_scheduler_config = {
                "scheduler": lr_scheduler,
                "interval": "step",
...
class LitModel_Gosai_Pairwise(LitModel_Gosai):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            learning_rate_reduce_metric=learning_rate_reduce_metric,
            learning_rate_reduce_mode=learning_rate_reduce_mode,
        )
